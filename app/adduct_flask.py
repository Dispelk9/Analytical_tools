...
def without_hydro(value_list):
    ...
    print("Without H")
    high_limit  = value_list["unifi_number"]  - value_list["neutralmass"] - (value_list["mass_error"]*value_list["neutralmass"]) + 0.001
    low_limit   = value_list["unifi_number"]  - value_list["neutralmass"] - (value_list["mass_error"]*value_list["neutralmass"]) - 0.001
...
def adduct_using_mass(value_list,number_of_hydro):
    ...
    high_limit  = value_list["unifi_number"]  - value_list["neutralmass"] - (value_list["mass_error"]*value_list["neutralmass"]) + 0.001 - value_list["hexact"]*float(Hydro_mode)
    low_limit   = value_list["unifi_number"]  - value_list["neutralmass"] - (value_list["mass_error"]*value_list["neutralmass"]) - 0.001 - value_list["hexact"]*float(Hydro_mode)
