...
import { getSpinnerCss as getComponentCss$o } from '../../../../../../components/dist/styles/esm/styles-entry.mjs';
import { parseAndGetAriaAttributes } from '../../../../../../components/dist/utils/esm/utils-entry.mjs';

class DSRSpinner extends Component {
    host;
    render() {
        const style = minifyCss(stripFocusAndHoverStyles(getComponentCss$o(this.props.size, this.props.theme)));
