...
const PMultiSelect = /*#__PURE__*/ forwardRef(({ description = '', disabled = false, dropdownDirection = 'auto', form, hideLabel = false, label = '', message = '', name, onUpdate, required = false, state = 'none', theme, value = [], className, children, ...rest }, ref) => {
    ...
    const props = {
        ...
        ...(!process.browser
            ? {
                children: (jsx(DSRMultiSelect, { description, disabled, dropdownDirection, form, hideLabel, label, message, name, required, state, theme: theme || useTheme(), value, children })),
            }
            : {
                children,
