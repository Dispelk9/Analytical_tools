...
class DSRTextList extends Component {
    ...
    render() {
        ...
        const style = minifyCss(stripFocusAndHoverStyles(getComponentCss$7(this.props.listType === 'ordered' ? this.props.orderType || 'numbered' : this.props.type, this.props.theme)));
