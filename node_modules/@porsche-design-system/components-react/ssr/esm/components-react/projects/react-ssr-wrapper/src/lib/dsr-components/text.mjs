...
class DSRText extends Component {
    ...
    render() {
        ...
        const style = minifyCss(stripFocusAndHoverStyles(getComponentCss$5(this.props.size, (weightDeprecationMap[this.props.weight] || this.props.weight), (alignDeprecationMap[this.props.align] || this.props.align), (colorDeprecationMap[this.props.color] || this.props.color), this.props.ellipsis, this.props.theme)));
